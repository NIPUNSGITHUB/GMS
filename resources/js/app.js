...
const routes = [
    ...
    { path: '/payment/history',component:require('./components/operation/payment/payment_history.vue').default},
    { path: '/all/feedback',component:require('./components/operation/feedback/feedback.vue').default}
